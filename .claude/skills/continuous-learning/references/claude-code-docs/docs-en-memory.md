...
* [Write and organize CLAUDE.md files](#CLAUDE.md%20files)
* [Scope rules to specific file types](#Organize%20rules%20with%20`.claude/rules/`) with `.claude/rules/`
* [Configure auto memory](#Auto%20memory) so Claude takes notes automatically
* [Troubleshoot](#Troubleshoot%20memory%20issues) when instructions aren't being followed
