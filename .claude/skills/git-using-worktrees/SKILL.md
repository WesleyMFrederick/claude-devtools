...
```bash
.claude/skills/git-automated-worktree/scripts/setup-worktree.sh continuous-learning phase3-visibility
.claude/skills/git-automated-worktree/scripts/setup-worktree.sh ptsf-tools event-qr-codes
.claude/skills/git-automated-worktree/scripts/setup-worktree.sh jact ast-refactor
```
